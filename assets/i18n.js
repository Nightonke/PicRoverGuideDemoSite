(function () {
  ...
  const translations = {
    en: {
      ...
      '识别并下载图片': 'Recognize and Download Images',
      '输入网页后，点击识别找到页面图片；选择需要的图片即可下载。连续图集可开启自动下一页。': 'Open a page, recognize images, select what you need, and download them.',
      ...
      '遇到连续图集时，长按其中一个链接搜索同类页面；确认后会排队逐个打开、识别并下载。': 'Find similar gallery links, queue them, then recognize and download page by page.',
      ...
      '点击底部识别按钮，选择图片后即可下载。': 'Tap the recognition button, select images, then download.',
      '在 PicRover 里这样操作': 'How to use it in PicRover',
      '打开本页地址': 'Open this page',
      '等待页面加载完成。': 'Wait for the page to load.',
      '点击识别': 'Tap Recognize',
      '首次可选择快速或深度识别。': 'Choose quick or deep recognition the first time.',
      '选择并下载': 'Select and download',
      '勾选图片，点击下载选中。': 'Check images, then tap Download Selected.',
      '图片示例': 'Image Examples',
      '点击识别后，下方图片会出现在图片面板中。': 'After recognition, these images appear in the image panel.',
      ...
      '点击识别后，只会更新当前工作区的图片面板。': 'After recognition, only this workspace image panel updates.',
      ...
      'PicRover 会逐页识别并保存。': 'PicRover recognizes and saves each page.',
      ...
      '进入任一章节后，还可以继续识别页面图片。': 'Open any chapter to keep recognizing page images.',
      ...
      '识别本页后，下载管理里应生成新的图片集合，或被自动下一页流程连续处理。': 'After recognition, a new image set should appear in Download Management or continue through auto-next.',
      '上一页': 'Previous Page',
      '最后一页': 'Final Page',
      ...
      '识别本页后，可以回到下载管理查看连续页面保存的图片文件夹。': 'After recognition, check Download Management for the saved gallery folder.',

      '返回多工作区引导': 'Back to Workspace Guide',
      '这是独立工作区示例页。你可以在本页单独识别图片，并和其他工作区的识别结果对比。': 'This is an independent workspace example. Recognize images here and compare them with other workspaces.',
      ...
      '这是排队下载流程中的第 1 个图集页面，可用于验证队列自动打开、识别和下载。': 'This is gallery page 1 in the queue flow, useful for checking automatic open, recognition, and download.',
      '这是排队下载流程中的第 2 个图集页面，可用于验证队列自动打开、识别和下载。': 'This is gallery page 2 in the queue flow, useful for checking automatic open, recognition, and download.',
      '这是排队下载流程中的第 3 个图集页面，可用于验证队列自动打开、识别和下载。': 'This is gallery page 3 in the queue flow, useful for checking automatic open, recognition, and download.',
      '这是排队下载流程中的第 4 个图集页面，可用于验证队列自动打开、识别和下载。': 'This is gallery page 4 in the queue flow, useful for checking automatic open, recognition, and download.',
      '这是排队下载流程中的第 5 个图集页面，可用于验证队列自动打开、识别和下载。': 'This is gallery page 5 in the queue flow, useful for checking automatic open, recognition, and download.',
      ...
      '这是备用图片集合，可用于继续测试 PicRover 的图片识别、选择和下载。': 'This extra image set can be used to keep testing recognition, selection, and downloads.',
      '备用可识别图片': 'Extra Recognizable Images',
      ...
      '这是备用批量图片集合，可用于测试更多图片数量下的识别、选中和下载。': 'This extra batch set can be used to test recognition, selection, and downloads with more images.',
      '主图片集合': 'Primary Image Set',
      '适合测试批量识别后的默认选中、手动选择和下载数量。': 'Useful for testing default selection, manual selection, and download counts after batch recognition.',
